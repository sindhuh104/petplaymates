class PetsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @pet.save
        format.html { redirect_to profile_path(current_user.profile), notice: 'Pet was successfully created.' }
  ...
  private
    ...
    def pet_params
      params.require(:pet).permit(:name, :breed, :age, :size, :picture, :availability, :user_id)
    end
end
